...
import org.apache.hadoop.mapred.JobConf;
	...
	//	Logger logger = LogManager.getLogger(MaxTemperatureDriver.class);
		//final Logger logger = LogManager.getLogger(MaxTemperatureDriver.class);
		final Logger logger = LoggerFactory.getLogger(MaxTemperatureDriver.class);
